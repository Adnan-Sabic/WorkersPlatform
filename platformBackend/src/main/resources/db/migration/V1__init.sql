...
(
    ...
    UNIQUE INDEX `idnotification_UNIQUE`
(
    `id` ASC
) VISIBLE,
    INDEX `fk_notification_user_idx`
(
    `userId` ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX `idadvertisement_UNIQUE`
(
    `id` ASC
) VISIBLE,
    INDEX `fk_advertisement_user1_idx`
(
    `userId` ASC
) VISIBLE,
    INDEX `fk_advertisement_category1_idx`
(
    `categoryId` ASC
) VISIBLE,
